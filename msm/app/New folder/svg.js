app.svgController = function($scope,$http){
	...
	$scope.Svg = {
		InitCurrJob: function(){
		    ...
		    curJob.y2Start = curJob.y1End + curJob.chartMarginTop2;
		...
		DrawCurrJobPlan: function(){
		    ...
		    rectP2.text = curJob.group.append("text").text(function(){
		        ...
		        x: rectP2.xStart + curJob.labelMarginLeft,
		        y: curJob.y1Start + curJob.yStartLabel,
		        class: "currPlan"
		    }).attr(curJob.labelAttr);
		...
		DrawCurrJobReal: function(){
		    ...
		    if(overSetup > 0){
		        ...
		        rect2.obj = curJob.group.append('rect').attr({
		            ...
		            width: rect2.width,
		            height: curJob.chartHeight,
		            class: "rect stroke-dash1 currReal",
		            id: "running2",
		            fill: "url(#hash2-1)"
		        });
		        rect2.text = "";
		    ...
		    rect1.text = curJob.group.append("text").text(function(){
		        ...
		        x: rect1.xStart + curJob.labelMarginLeft,
		        y: curJob.y2Start + curJob.yStartLabel,
		        class: "currReal"
		    }).attr(curJob.labelAttr);
		   ...
		   //  Run ในเวลา ///////////////////////////////////////////////////////////////////
		    ...
		    if(widthRN > 0){
		        ...
		        rect3.text = curJob.group.append("text").text(function(){
		            ...
		            x: rect3.xStart + curJob.labelMarginLeft,
		            y: curJob.y2Start + curJob.yStartLabel,
		        	class: "currReal"
		        }).attr(curJob.labelAttr);
		...
		DrawJobTodayReal: function(){
			$('.todayReal').remove();
			jobToday.real = null;
			jobToday.real = $scope.Svg.DrawJobTodayBar($scope.todayPlanReal,'REAL_USED_TIME','todayReal',jobToday.y3Start,jobToday.chart3Style,true);
		},
		DrawJobTodayBar: function(data,col,clas,y,css,flag){
    		...
    		for(i = 0;i < data.length; i++){
			    ...
			    rect.text = jobToday.group.append("text").text(function(){
			        ...
			        x: rect.xStart + jobToday.labelMarginLeft,
